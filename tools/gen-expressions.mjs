...
const SOURCES = [
  'lessons/18-slang-idioms.html',
  'lessons/92-small-talk.html',
  'lessons/94-idioms-body.html',
  'lessons/95-idioms-animals.html',
  'lessons/96-idioms-food.html',
  'lessons/197-idioms-master.html',
];
...
const out = outIdx >= 0 ? args[outIdx + 1] : dataPath('expressions.json');
const payload = {
